...
const Skills = () => {
  return (
    <div name='skills' className='w-full h-auto pt-14 bg-gradient-to-b from-orange-800 to-sky-900 text-gray-200'>
        {/* cont */}
        <div className='max-w-[1000px] mx-auto px-10 p-4 flex flex-col justify-center w-full h-full'>
            <div>
            ...
            <div className='w-full grid grid-cols-2 sm:grid-cols-3 gap-6 text-center py-8 px-10'>
