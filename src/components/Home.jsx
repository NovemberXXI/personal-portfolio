...
const Home = () => {
  return (
    <div name='home' className='w-full h-screen bg-gradient-to-b from-sky-900 via-sky-900 to-orange-800'>
        {/* conta */}
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            <p className='text-black text-xl '>Hello, my name is</p>
            <h1 className='text-5xl sm:text-7xl py-2 font-bold text-[#ccd6f6]'>Edmond Setati</h1>
